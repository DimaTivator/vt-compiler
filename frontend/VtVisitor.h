...
public:
   ...
   */
    ...
    virtual std::any visitPrintsStmt(VtParser::PrintsStmtContext *context) = 0;

    virtual std::any visitPrintiStmt(VtParser::PrintiStmtContext *context) = 0;
    ...
    virtual std::any visitStringLiteral(VtParser::StringLiteralContext *context) = 0;
