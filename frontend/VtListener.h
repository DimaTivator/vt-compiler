...
public:
  ...
  virtual void enterPrintsStmt(VtParser::PrintsStmtContext *ctx) = 0;
  virtual void exitPrintsStmt(VtParser::PrintsStmtContext *ctx) = 0;

  virtual void enterPrintiStmt(VtParser::PrintiStmtContext *ctx) = 0;
  virtual void exitPrintiStmt(VtParser::PrintiStmtContext *ctx) = 0;
  ...
  virtual void enterNegExpr(VtParser::NegExprContext *ctx) = 0;
  virtual void exitNegExpr(VtParser::NegExprContext *ctx) = 0;
