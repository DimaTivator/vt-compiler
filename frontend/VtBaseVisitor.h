...
public:
    ...
    virtual std::any visitAssignment(
        VtParser::AssignmentContext* ctx) override {
        return visitChildren(ctx);
    }
    ...
    virtual std::any visitStringLiteral(
        VtParser::StringLiteralContext* ctx) override {
        return visitChildren(ctx);
    }
    ...
    virtual std::any visitComparison(
        VtParser::ComparisonContext* ctx) override {
        return visitChildren(ctx);
    }
    ...
    virtual std::any visitParensExpr(
        VtParser::ParensExprContext* ctx) override {
        return visitChildren(ctx);
    }

    virtual std::any visitIntLiteral(
        VtParser::IntLiteralContext* ctx) override {
        return visitChildren(ctx);
    }
