...
public:
  ...
  enum {
    ...
    RulePrintsStmt = 5, RulePrintiStmt = 6, RuleIfStmt = 7, RuleWhileStmt = 8, 
    RuleBlock = 9, RuleExpr = 10
  };
  ...
  class PrintsStmtContext;
  class PrintiStmtContext;
  class IfStmtContext;
  ...
  public:
    ...
    PrintsStmtContext *printsStmt();
    PrintiStmtContext *printiStmt();
  ...
  class  PrintsStmtContext : public antlr4::ParserRuleContext {
  public:
    PrintsStmtContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ExprContext *expr();
  ...
  class  PrintiStmtContext : public antlr4::ParserRuleContext {
  public:
    PrintiStmtContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ExprContext *expr();
